# Promon Planning Documents

Promon is a Rust-first Node.js process manager intended to provide PM2-like operational behavior across Windows, macOS, and Linux. This directory contains the product and engineering planning documents that should guide implementation.
...
4. Promon initially supports Node.js applications only.
